...
public class PassageiroController {
    ...
    public ResponseEntity<List<PassageiroCompletoResponse>> consultar(){
        ...
        for (PassageiroCompletoResponse passageiro: resp) {
            CheckIn checkIn = checkInService.consultarPorCpf(passageiro.getCpf());
            if (checkIn != null){
                passageiro.setEticket(checkIn.getEticket());
                passageiro.setDataHoraConfirmacao(checkIn.getDataHoraConfirmacao());
                passageiro.setAssento(checkIn.getAssento());
            }
        }
